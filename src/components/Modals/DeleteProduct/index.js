          ...
          <TouchableOpacity
            ...
            <View style={styles.modalContent} onStartShouldSetResponder={() => true}>
              ...
              <View style={{ alignItems: 'center', justifyContent: 'center', }}>
                ...
                <Text style={[styles.privatetext, { marginTop: responsiveScreenHeight(2.5), }]}>Do you want to delete</Text>
                <Text style={styles.privatetext}>{item ? item.sneakerName : 'this item'} ?</Text>
              </View>
              <View
                style={[
                  styles.row,
                ...
                <TouchableOpacity style={styles.textContainer} onPress={props.onDelete}>
